...
class Payments(Base):
    ...
    employee_payroll_id = Column(Integer, ForeignKey("employee_payroll.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    employee_payroll_tab = relationship("EmployeePayroll")
